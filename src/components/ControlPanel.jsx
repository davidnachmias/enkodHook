      ...
      <div className="prompt-section">
        <div className="prompt-header">
          <div className="prompt-label">
            ...
            <span className="prompt-required">(Required)</span>
        ...
        {advancedOptionsOpen && (
          <div className="advanced-content">
            <div className="options-grid">
              <div>
                <label className="option-label">UI Type</label>
                <Select
                  ...
                  options={[
                    ...
                    {
                      value: "Character Stats Panel",
                      label: "Character Stats Panel",
                    },
            ...
            <div className="options-grid">
              ...
              <div>
                <label className="option-label">Interaction</label>
                <Select
                  value={config.interaction || "Static"}
                  onChange={(value) =>
                    setConfig({ ...config, interaction: value })
                  }
                  options={[
            ...
            <div className="option-group">
              <div className="checkbox-row">
                <span className="checkbox-label">Show Placeholder Text</span>
                <input
                  type="checkbox"
                  checked={config.showPlaceholder || false}
                  onChange={(e) =>
                    setConfig({ ...config, showPlaceholder: e.target.checked })
                  }
              ...
              <div className="checkbox-row">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig({ ...config, wireframe: e.target.checked })
                  }
                  className="checkbox-input"
                />
              </div>
      ...
      <div className="generation-controls">
        <div className="credits-info">
          <div className="credits-display">
            ...
            <span className="credits-text">{credits} credit Remaining</span>
          </div>
        </div>
